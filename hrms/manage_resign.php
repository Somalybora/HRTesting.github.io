...
<div class="container-fluid">
	...
	<form action="" id="manage_resign">
		...
		<div class="form-group">
			...
			<input type="text" name="fenglish" id="fenglish" class="form-control" value="<?php echo isset($fenglish) ? $fenglish : '' ?>" required>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="personal_contact" class="form-control form-control-sm" required value="<?php echo isset($personal_contact) ? $personal_contact : '' ?>">
			</div>
			<div class="form-group">
				<label class="control-label">Starting Date</label>
				<input type="date" name="start_date" id="start_date" value="<?php echo isset($start_date) ? $start_date: '' ?>" class="form-control" required onchange="calculateDays()">
			</div>
			<div class="form-group">
				<label class="control-label">Last Working Date</label>
				<input type="date" name="end_date" id="end_date" value="<?php echo isset($end_date) ? $end_date: '' ?>" class="form-control" required onchange="calculateDays()">
			</div>
    <div class="form-group" >
