			...
			<form action="" id="manage_hardship">
				...
				<div class="row-center">
					<div class="col-md-4">
						...
						<div class="form-group">
							<label for="fenglish" class="control-label">FullName</label>
							<input type="text" name="fenglish" class="form-control form-control-sm" value="<?php echo isset($fenglish) ? $fenglish : '' ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<select name="hard_type" id="hard_type" value="<?php echo isset($hard_type) ? $hard_type : "" ?>" class="form-control form-control-sm rounded-0" required>
						...
						<div class="form-group">
							<label for="" class="control-label">Application Date</label>
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'index.php/?page=hardship_list'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.replace('index.php/?page=hardship_list')
					},750)
				}else if(resp == 2){
					$('#msg').html("<div class='alert alert-danger'>ID already exist.</div>");
