	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-info border-secondary mr-2" href="./index.php?page=new_user"><i class="fa fa-plus"></i> Add New User</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table table-striped table-bordered" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center"><b><?php echo $row['role'] ?></b></td>
